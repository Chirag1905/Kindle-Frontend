...
import { DepartmentEnum } from "@/app/(client)/admin/employee/_components/EmployeeEnum";
...
export default function UserMetaCard({
  ...
  console.log('Props:', { firstName, lastName, employeeId, isActive, department });
  ...
  // Debug logs for department values
  React.useEffect(() => {
    console.log('DepartmentEnum values:', Object.values(DepartmentEnum));
    console.log('Current department in formData:', formData.department);
  }, [formData.department]);
        ...
        <div className="flex flex-col gap-5 xl:flex-row xl:items-center xl:justify-between">
          <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
            <div className="relative group">
              ...
              <button
                className="absolute inset-0 flex items-center justify-center w-full h-full transition-opacity bg-black bg-opacity-50 rounded-full opacity-0 cursor-pointer group-hover:opacity-100"
                onClick={openModal}
                  ...
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    >
                      ...
                      {Object.values(DepartmentEnum).map((dept) => {
                        ...
                        console.log(`Option ${dept}: ${isSelected ? 'selected' : 'not selected'}`);
                        return (
